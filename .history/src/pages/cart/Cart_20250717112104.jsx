...
const storage = getStorage(app);
  ...
  const sendPDFReceipts = async () => {
    ...
    const { paymentId, addressInfo, cartItems, totalAmount, shipping, grandTotal, orderDate } = paymentDetails;
  ...
  const email = paymentDetails?.email || JSON.parse(localStorage.getItem("user")).user.email;
    try {
    // Upload the blob
