  ...
  const buyNow = async () => {
   ...
   //  ************   PDF generate via jsPDF **************
         const generatePDFReceipts = () => {
           ...
           const { paymentId, addressInfo, orderInfo, cartItems, totalAmount, shipping, grandTotal } = paymentDetails;

           onsole.log('Generating PDF with paymentDetails:', paymentDetails);
      ...
      doc.text(`Date: ${orderInfo.date}`, 20, 85);
      doc.text(`Email: ${orderInfo.email}`, 20, 95);
