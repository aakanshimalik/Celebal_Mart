        ...
        >
            ...
            <div className=' bg-gray-800 px-10 py-10 rounded-xl '>
                ...
                <div className=' flex justify-center mb-3'>
                    <button
                        onClick={signup}
                        className=' bg-red-600 w-full text-black font-bold  px-2 py-2 rounded-lg hover:bg-red-400'>
                        Signup
                    </button>
                </div>
                <div>
                    <h2 className='text-white  mt-3'>Already have an account?  <Link className=' text-red-500 font-bold' to={'/login'}>Login</Link></h2>
                </div>
            </div>
        </div>
    )
