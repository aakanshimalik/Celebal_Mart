    ...
    return (
        <div className=" min-h-screen bg-gradient-to-r from-red-500 cia-white to-white p-7">
            ...
            <div className="border h-auto w-auto p-10 border-gray-500">
                ...
                <span>
                    At Celebal-Mart, a project by <b>Aakanshi Malik(React JS Intern , CSI'25)</b>, we value your privacy and are committed to protecting your personal information. We collect basic user details such as name, email, address, and order history to process transactions, improve our services, and send receipts or updates via email using secure third-party tools like Firebase and EmailJS. Your data is never sold or misused, and all interactions follow standard privacy and security practices. By using our platform, you agree to this policy. For any concerns, contact me at <a href="https://mail.google.com" className=" text-blue-300 hover:text-blue-800">aakanshimalik54@gmail.com</a>
                </span>
            </p>
            </div>
