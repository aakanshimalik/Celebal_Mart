                ...
                <div className="container px-5 py-10 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                           {/*  Testimonial-1 (PRERNA KAMAT) */}
                            <div className="h-full text-center shadow-md border  border-gray-200 rounded-lg p-5">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            {/*  Testimonial-2 (Aakanshi Malik(me)) */}
                            <div className="h-full text-center shadow-md border border-gray-200 rounded-lg  p-5">
