                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  style={{color: mode === 'dark' ? 'white' : ''}}className="leading-relaxed">
                                    My internship at Celebal Technologies has been an incredible experience of learning and professional growth. Working on real-time React projects with experienced mentors gave me the hands-on exposure I was looking for. The culture here is supportive and inclusive, and I was encouraged to ask questions, experiment, and contribute from day one. I’m grateful for the opportunity to sharpen both my technical and soft skills in such a forward-thinking environment.
                                </p>
                                <span className="inline-block h-1 w-10 rounded bg-red-500 mt-6 mb-4" />
                                <h2 style={{color: mode === 'dark' ? '#ff4162' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">React Js Intern</h2>
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="text-gray-500">Celebal Summer Internship</p>
                            </div>
                        </div>
