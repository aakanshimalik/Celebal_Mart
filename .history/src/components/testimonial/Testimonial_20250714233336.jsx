                ...
                <div className="container px-5 py-10 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center shadow-md border border-gray-200 p-5">
                                <img alt="testimonial" className="w-20 h-20 mb-8 mt-3 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src={testimonial1} />
                                ...
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="text-gray-500 mb-3">Human Resource</p>
                            </div>
                        </div>
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
