...
function Filter() {
    ...
    return (
        <div>
           <div className=' container mx-auto px-4 mt-5 w-full'>
                <div className="p-5 rounded-lg bg-yellow-100 drop-shadow-xl border border-gray-200"
                    style={{
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="px-8 py-3 w-full rounded-md bg-violet-0 border-transparent outline-0 text-sm border border-gray-300 focus:border-black dark:focus:border-gray-400" style={{ backgroundColor: mode === 'dark' ? 'rgb(64 66 70)' : '', color: mode === 'dark' ? 'white' : '', }} />
                    </div>
